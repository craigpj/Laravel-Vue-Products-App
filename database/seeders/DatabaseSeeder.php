...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('products')->insert([
            ...
            ['name' => 'Northcote 21',
            'price' => 15180000,
            'description' => 'The Northcote is the ultimate first family home, with the option to add a fourth bedroom to the layout. Enjoy all the benefits of a floorplan that meets your needs, with a spacious meals and family hub leading outside and extra storage next to the laundry and main bathroom, exactly where you need it. This is a home that ticks all the boxes.',
            'bedrooms' => 1,
            'bathrooms' => 1,
            'status_id' => 2,
            'user_id' => 1],
        ...
        DB::table('images')->insert([['path' => '0b300051410f23b0aca3e9bab268a93c.jpeg', 'product_id' => 1, 'user_id' => 1, 'status_id' => 2],
            ...
            ['path' => '4f967d68e7ec81f09a17a06b0952a9f1.jpeg', 'product_id' => 5, 'user_id' => 1, 'status_id' => 2],                  
            ['path' => '5aa5782d8649af399144a8d483f3e6e4.jpeg', 'product_id' => 6, 'user_id' => 1, 'status_id' => 2],                  
            ['path' => '5c20fdd0be8dd0e11ef1a5c8a0471a2c.jpeg', 'product_id' => 7, 'user_id' => 1, 'status_id' => 2],                  
            ['path' => '7a9b71ff960a72c4ad2233be8979c507.jpeg', 'product_id' => 8, 'user_id' => 1, 'status_id' => 2],                  
            ['path' => '9a9322ddfc9daa1f62a06b1039ed8e62.jpeg', 'product_id' => 5, 'user_id' => 1, 'status_id' => 2],                  
            ['path' => 'd0af62acfab57e2d0fbdc7b1d5526ac3.jpeg', 'product_id' => 6, 'user_id' => 1, 'status_id' => 2],                  
            ['path' => 'dc25679f251090aaa7cdfeb24a0e9dd8.jpeg', 'product_id' => 7, 'user_id' => 1, 'status_id' => 2],                  
            ['path' => 'f1a1da586a611d1747f569bea50c6f56.jpeg', 'product_id' => 8, 'user_id' => 1, 'status_id' => 2],
